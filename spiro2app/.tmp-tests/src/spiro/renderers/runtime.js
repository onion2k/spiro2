...
export function stepRuntime(options) {
    const { state, layers, compiledLayers, isPaused, amplitudeMod, frequencyMod, phaseMod, noiseMode, noiseAmount, noiseFrequency, noiseSpeed, noiseOctaves, noiseSeed, maxTrailPointsPerLayer, timeMs, width, height, } = options;
